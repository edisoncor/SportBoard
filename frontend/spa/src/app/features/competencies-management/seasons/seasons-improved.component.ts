          ...
          <form [formGroup]="seasonForm" (ngSubmit)="onSubmit()" class="modern-form">
              ...
              <div class="form-row">
                ...
                <mat-form-field appearance="outline" class="form-field">
                  ...
                  <mat-select formControlName="competition">
                    ...
                    <mat-option value="1">Copa América 2024</mat-option>
                    <mat-option value="2">Liga Colombiana de Fútbol</mat-option>
                    <mat-option value="3">Torneo Regional de Baloncesto</mat-option>
                    <mat-option value="4">Campeonato Sudamericano de Tenis</mat-option>
                    <mat-option value="5">Liga Local de Volleyball</mat-option>
                    <mat-option value="6">Copa Libertadores</mat-option>
                    <mat-option value="7">Liga Europea de Baloncesto</mat-option>
                    <mat-option value="8">Mundial de Atletismo</mat-option>
                  </mat-select>
            ...
            <div class="form-actions-row">
              ...
              <button mat-raised-button color="primary" type="submit" 
                ...
                {{ loading ? 'Guardando...' : (editingSeason ? 'Actualizar' : 'Crear') }}
...
export class SeasonsComponent implements OnInit {
  ...
  onSubmit(): void {
    if (this.seasonForm.valid) {
      this.loading = true;
      const formData = this.seasonForm.value;

      if (this.editingSeason) {
        this.updateSeason(formData);
      } else {
        this.createSeason(formData);
      }
    }
  }
  ...
  editSeason(season: Season): void {
    ...
    this.seasonForm.patchValue({
      ...
      competition: season.competition.toString(),
