              ...
              <div class="form-row">
                ...
                <mat-form-field appearance="outline" class="form-field">
                  ...
                  <mat-select formControlName="administration">
                    ...
                    <mat-option value="1">Federación Colombiana de Fútbol</mat-option>
                    <mat-option value="2">Liga de Baloncesto de Medellín</mat-option>
                    <mat-option value="3">Asociación de Tenis de Buenos Aires</mat-option>
                    <mat-option value="4">Club de Natación São Paulo</mat-option>
                    <mat-option value="5">Federación Peruana de Volleyball</mat-option>
                    <mat-option value="6">Liga Mexicana de Béisbol</mat-option>
                    <mat-option value="7">Confederación Sudamericana de Fútbol</mat-option>
                    <mat-option value="8">Federación Internacional de Atletismo</mat-option>
                  </mat-select>
...
export class CompetitionsComponent implements OnInit {
  ...
  editCompetition(competition: Competition): void {
    ...
    this.competitionForm.patchValue({
      ...
      administration: competition.administration.toString(),
