              ...
              <div class="form-row">
                ...
                <mat-form-field appearance="outline" class="form-field">
                  ...
                  <mat-select formControlName="nationality">
                    <mat-option value="">Seleccione una nacionalidad</mat-option>
                    <mat-option value="1">Colombia</mat-option>
                    <mat-option value="2">Argentina</mat-option>
                    <mat-option value="3">Brasil</mat-option>
                    <mat-option value="4">Chile</mat-option>
                    <mat-option value="5">Perú</mat-option>
                    <mat-option value="6">Ecuador</mat-option>
                    <mat-option value="7">Uruguay</mat-option>
                    <mat-option value="8">Paraguay</mat-option>
                    <mat-option value="9">Venezuela</mat-option>
                    <mat-option value="10">Bolivia</mat-option>
                    <mat-option value="11">España</mat-option>
                    <mat-option value="12">Francia</mat-option>
                    <mat-option value="13">Italia</mat-option>
                    <mat-option value="14">Alemania</mat-option>
                    <mat-option value="15">Inglaterra</mat-option>
                  </mat-select>
...
export class TeamsComponent implements OnInit {
  ...
  calculateStats(): void {
    this.uniqueNationalities = new Set(this.teams.map(t => t.nationality)).size;
    this.uniqueCategories = new Set(this.teams.filter(t => t.category).map(t => t.category)).size;
