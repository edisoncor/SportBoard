            ...
            <div class="form-section">
              ...
              <div class="form-row">
                ...
                <mat-form-field appearance="outline" class="form-field">
                  ...
                  <input matInput formControlName="province" placeholder="Ej: Cundinamarca">
              ...
              <div class="form-row">
                ...
                <mat-form-field appearance="outline" class="form-field">
                  ...
                  <input matInput formControlName="location" placeholder="Ej: Carrera 7 # 32-16">
...
export class AdministrationsComponent implements OnInit {
  ...
  onSubmit(): void {
    if (this.administrationForm.valid) {
      this.loading = true;
      const formData = this.administrationForm.value;
  ...
  duplicateAdministration(admin: Administration): void {
    ...
    this.competenciesService.createAdministration(duplicatedAdmin).subscribe({
      next: () => {
